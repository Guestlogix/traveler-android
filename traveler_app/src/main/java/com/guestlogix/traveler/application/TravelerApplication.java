...
public class TravelerApplication extends Application {
    ...
    public void onCreate() {
        ...
        TravelerPrefs.getInstance(this).save(TravelerPrefs.Key.TRAVELER_AUTH_ENDPOINT, PRODUCTION_AUTH_ENDPOINT);
        TravelerPrefs.getInstance(this).save(TravelerPrefs.Key.TRAVELER_SDK_ENDPOINT, PRODUCTION_ENDPOINT);
