...
@Config(application = CatalogItemDetailsFragmentTest.TestApplication.class)
public class CatalogItemDetailsFragmentTest {
    private FragmentScenario<CatalogItemDetailsFragment> fragmentScenario;
