...
public class PartnerOfferingsQuantityFragment extends Fragment {
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        ...
        view.findViewById(R.id.btnCheckout).setOnClickListener(v -> Traveler.fetchPurchaseForm(partnerOfferingItem, (List<ProductOffering>) (List<?>) lstSelectedPartnerOfferings, new FetchPurchaseFormCallback() {
            @Override
