...
/**
 * Class which handles building and binding for the form.
 */
...
public class FormBuilder {
    ...
    /**
     * Populates a cell based in the given cell type.
     *
     * @param cell       Cell to populate.
     * @param descriptor Options to populate the cell with.
     * @param type       Type of cell.
     * @param ds         Data source callback for the cell.
     */
