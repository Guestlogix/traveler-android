            ...
            while (reader.hasNext()) {
                ...
                switch (key) {
                    ...
                    case "searchParams":
                        ...
                        switch (type) {
                            case BOOKING:
                                BookingSearchParameters bookingSearchParameters = new BookingSearchParameters.BookingSearchParametersObjectMappingFactory().instantiate(reader);
                                searchQuery = new BookingQuery(bookingSearchParameters);
                                break;
                            case PARKING:
                                ParkingSearchParameters parkingSearchParameters = new ParkingSearchParameters.ParkingSearchParametersObjectMappingFactory().instantiate(reader);
                                searchQuery = new ParkingQuery(parkingSearchParameters);
                                break;
                        }
                        break;
                    default:
